...
Return your answer by calling the function ExecuteCode with exactly two keys:
- "code": the one-line mathematical expression to execute by numexpr.evaluate()..
- "reasoning": a brief explanation of the derivation (if nothing special, you can say "Direct translation of the problem").

you will be punished if you not provide the both code and reasoning to function ExecuteCode.
"""
...
class ExecuteCode(BaseModel):
    """The input to the numexpr.evaluate() function. please provide the both reasoning and code."""
...
def get_math_tool(llm: ChatGroq):
